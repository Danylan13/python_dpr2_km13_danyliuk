...
def update_hand(hand, word):
    ...
    for letter in hand.keys():
        a = hand.get(letter, 0) - word.count(letter)
        if a > 0:
            new_hand[letter] = a
...
def is_valid_word(word, hand, word_list):
    ...
    if "*" in word:
        for letter in VOWELS:
            word_2 = word.replace("*", letter)
            hand_2 = hand.copy()
            hand_2[letter] = hand.get(letter, 0) + 1
            if is_valid_word(word_2, hand_2, word_list):
                return True
    ...
    while calculate_handlen(hand) > 0:
        ...
        # If the word is valid:
            ...
            # and the updated total score
                ...
                print(f'"{word}" earned {word_total} points.')
                total_points += word_total
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    while hands_number != 0:
        ...
        substitute_hand_2 = input('Would you like to subtitute hand?: ')
        if substitute_hand_2 == 'yes':
            letter = input('Which letter would you like to replace?: ')
            hand = substitute_hand(hand, letter)

        total_score += play_hand(hand, word_list)

        if not replay_hand_2:
